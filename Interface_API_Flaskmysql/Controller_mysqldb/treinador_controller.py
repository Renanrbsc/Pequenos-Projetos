...
from Interface_API_Flaskmysql.Dao_mysqldb.treinador_dao import TreinadorDao
from Interface_API_Flaskmysql.Model_mysqldb.treinador_model import TreinadorModel
from Interface_API_Flaskmysql.Controller_mysqldb.base_controller import BaseController
