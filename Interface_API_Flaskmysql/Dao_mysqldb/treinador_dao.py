...
from Interface_API_Flaskmysql.Model_mysqldb.treinador_model import TreinadorModel
from Interface_API_Flaskmysql.Dao_mysqldb.database_config import DatabaseConfig
...
class TreinadorDao(DatabaseConfig):
    ...
    def get_all(self):
        ...
        for treinador in treinador_all:
            treinador = TreinadorModel(treinador[1], treinador[2], treinador[3], treinador[4], treinador[5],
                                       treinador[0])
