...
from Interface_API_Alchemy.Model_Terminal.treinador_model import TreinadorModel
from Interface_API_Alchemy.Model_Terminal.pokemon_model import PokemonModel
