from Orientacao_Objeto_Python.Exercicio_classes.administrador import Administrador
from Orientacao_Objeto_Python.Exercicio_classes.engenheiro import Engenheiro
from Orientacao_Objeto_Python.Exercicio_classes.professor import Professor
